...
func TestObfuscateV4_hex_encode(t *testing.T) {
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	//------------------------------------------------------------
	dataString = "test BBB>>>www|||qqq 123"
	EXPECTED_result = "2A272B227E2D5C2D606D606B2739222A225C2D5C7E606C27"
	//------------------------------------------------------------
	result = ObfuscateV4_hex_encode(dataString)
	//------------------------------------------------------------
	if result != EXPECTED_result {
		t.Errorf("result = %v but should = %v", result, EXPECTED_result)
	}
...
func TestObfuscateV4_hex_decode(t *testing.T) {
	//------------------------------------------------------------
	var err error
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	//------------------------------------------------------------
	dataString = "2A272B227E2D5C2D606D606B2739222A225C2D5C7E606C27"
	EXPECTED_result = "test BBB>>>www|||qqq 123"
	//------------------------------------------------------------
	result, err = ObfuscateV4_hex_decode(dataString)
	//------------------------------------------------------------
	if err != nil {
		t.Error(err)
	} else {
...
func TestObfuscateV5_hex_encode(t *testing.T) {
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	//------------------------------------------------------------
	dataString = "test BBB>>>www|||qqq 123"
	EXPECTED_result = "2A272B227E2D5C2D606D606B2739222A225C2D5C7E606C27"
	//------------------------------------------------------------
	result = ObfuscateV5_hex_encode(dataString)
	//------------------------------------------------------------
	if result != EXPECTED_result {
		t.Errorf("result = %v but should = %v", result, EXPECTED_result)
	}
...
func TestObfuscateV5_hex_decode(t *testing.T) {
	//------------------------------------------------------------
	var err error
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	...
	EXPECTED_result = "test BBB>>>www|||qqq 123"
	//------------------------------------------------------------
	result, err = ObfuscateV5_hex_decode(dataString)
	//------------------------------------------------------------
	if err != nil {
		t.Error(err)
	} else {
...
func TestObfuscateXOR(t *testing.T) {
	...
	//------------------------------------------------------------
	result, err := ObfuscateXOR(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "abcd"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "abcd"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "C=HdZ"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "C=HdZ"
	value := byte(32)
	EXPECTED_result := "ABCD"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base64_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "YWJjZA=="
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base64_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base64_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "YWJjZA=="
	value := byte(32)
	EXPECTED_result := "ABCD"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base64_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base64url_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "YWJjZA"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base64url_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base64url_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "YWJjZA=="
	value := byte(32)
	EXPECTED_result := "ABCD"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base64url_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base91_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "ABCD"
	value := byte(32)
	EXPECTED_result := "#G(IZ"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base91_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_base91_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "#G(IZ"
	value := byte(32)
	EXPECTED_result := "ABCD"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_base91_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		//------------------------------------------------------------
		t.Error(err)
...
func TestObfuscateXOR_hex_encode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "test BBB>>>www|||qqq 123"
	value := byte(32)
	EXPECTED_result := "54455354006262621E1E1E5757575C5C5C51515100111213"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_hex_encode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		t.Error(err)
	} else {
...
//------------------------------------------------------------
// ObfuscateXOR_hex_decode
//------------------------------------------------------------

func TestObfuscateXOR_hex_decode(t *testing.T) {
	//------------------------------------------------------------
	dataString := "54455354006262621E1E1E5757575C5C5C51515100111213"
	value := byte(32)
	EXPECTED_result := "test BBB>>>www|||qqq 123"
	//------------------------------------------------------------
	result, err := ObfuscateXOR_hex_decode(dataString, value)
	//------------------------------------------------------------
	if err != nil {
		t.Error(err)
	} else {
...
func TestSwapStringV0_hex_encode(t *testing.T) {
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	//------------------------------------------------------------
	dataString = "test BBB>>>www|||qqq 123"
	EXPECTED_result = "2A392B2A7E5C5C5C6060602727272222222D2D2D7E6D6C6B"
	//------------------------------------------------------------
	result = SwapStringV0_hex_encode(dataString)
	//------------------------------------------------------------
	if result != EXPECTED_result {
		t.Errorf("result = %v but should = %v", result, EXPECTED_result)
	}
...
func TestSwapStringV0_hex_decode(t *testing.T) {
	//------------------------------------------------------------
	var err error
	//------------------------------------------------------------
	var dataString, result, EXPECTED_result string
	//------------------------------------------------------------
	dataString = "2A392B2A7E5C5C5C6060602727272222222D2D2D7E6D6C6B"
	EXPECTED_result = "test BBB>>>www|||qqq 123"
	//------------------------------------------------------------
	result, err = SwapStringV0_hex_decode(dataString)
	//------------------------------------------------------------
	if err != nil {
		t.Error(err)
	} else {
