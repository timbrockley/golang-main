...
type ObfuscationOption func(*ObfuscationOptions)
...
var DefaultObfuscationOptions = ObfuscationOptions{
	Encoding: "",
	MixChars: true,
}
...
func WithEncoding(encoding string) ObfuscationOption {
	return func(options *ObfuscationOptions) { options.Encoding = encoding }
}

func WithMixChars(mixChars bool) ObfuscationOption {
	return func(options *ObfuscationOptions) { options.MixChars = mixChars }
}

//----------------------------------------------------------------------

func NewObfuscationOptions(options ...ObfuscationOption) ObfuscationOptions {
	obfuscationOptions := DefaultObfuscationOptions
...
//
//	[WithMixChars]
func ObfuscateV4(dataString string, Options ...ObfuscationOption) string {
	//------------------------------------------------------------
	if dataString == "" {
		return dataString
	}
	...
	dataBytes = []byte(dataString)
	//------------------------------------------------------------
	options := NewObfuscationOptions(Options...)
	//------------------------------------------------------------
	if options.MixChars && len(dataBytes) >= 4 {
		//--------------------
...
//	[WithEncoding]
//	[WithMixChars]
func ObfuscateV4Encode(dataString string, Options ...ObfuscationOption) string {
	//------------------------------------------------------------
	if dataString == "" {
		return dataString
	}
...
//	[WithEncoding]
//	[WithMixChars]
func ObfuscateV4Decode(dataString string, Options ...ObfuscationOption) (string, error) {
	//------------------------------------------------------------
	var err error
	//------------------------------------------------------------
	if dataString == "" {
