...
func TestObfuscateData(t *testing.T) {
	...
	testCases := []struct {
		...
		{"?", false, true, "", "illegal base64 data at input byte 0"},
		{"", false, false, "", ""},
		{"ABCD", false, false, "]\\[Z", ""},
		{"]\\[Z", false, false, "ABCD", ""},
		{"ABCD", true, false, "XVxbWg==", ""},
		{"XVxbWg==", false, true, "ABCD", ""},
	}
	//--------------------------------------------------
...
func TestBase91_encode(t *testing.T) {
	...
	//--------------------------------------------------
	base91String = "fG^F%w_o%5qOdwQbFrzd[5eYAP;gMP+f#G(Ic,5ph#77&xrmlrjgs@DZ7UB>xQGrgw_,\x24k_i\x24Js@Tj\x24MaRDa7dq)L1<[3vwV[|O/7%q{{9G\x60C/LM"
	dataString = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#\x24%&()*+,./:;<=>?@[]^_\x60{|}~\x22"
	//--------------------------------------------------
	resultString = Base91_encode(dataString, false)
	//--------------------------------------------------
	if resultString != base91String {
	...
	//--------------------------------------------------
	base91String = "fG^F%w_o%5qOdwQbFrzd[5eYAP;gMP+f#G(Ic,5ph#77&xrmlrjgs@DZ7UB>xQGrgw_,-dk_i-dJs@Tj-dMaRDa7dq)L1<[3vwV[|O/7%q{{9G-gC/LM"
	dataString = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!#\x24%&()*+,./:;<=>?@[]^_\x60{|}~\x22"
	//--------------------------------------------------
	resultString = Base91_encode(dataString, true)
	//--------------------------------------------------
